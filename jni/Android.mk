...
LOCAL_CFLAGS += -O2 -I$(LOCAL_PATH)/libipset/include \
				-I$(LOCAL_PATH)/libcork/include

LOCAL_SRC_FILES := $(addprefix libipset/,$(IPSET_SOURCE))
...
LOCAL_CFLAGS += -O2 -I$(LOCAL_PATH)/libcork/include \
				-DCORK_API=CORK_LOCAL

LOCAL_SRC_FILES := $(addprefix libcork/,$(CORK_SOURCE))
...
LOCAL_C_INCLUDES:= $(LOCAL_PATH)/ssv5

ssv5_srcs := $(wildcard $(LOCAL_PATH)/ssv5/*.c)
net_srcs := $(wildcard $(LOCAL_PATH)/packet/*.c)

LOCAL_SRC_FILES:= localvpnservice.c $(ssv5_srcs) $(net_srcs)

LOCAL_CFLAGS    := -Wall -O2 -fno-strict-aliasing -DLIB_ONLY -DMODULE_LOCAL \
